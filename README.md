...
### サイトテーマ
　廃棄されてしまう野菜を持つ生産者と、フードロスに取り組むレストランをつなぐ物々交換プラットフォーム
 
### テーマを選んだ理由
　私が以前農業に従事する中で、店頭にならばない、市場にさえ流通しない大量の余剰廃棄野菜があることを問題に思っていました。
 農家のコミュニティーの中では、それぞれが生産したものを **おすそわけ** の形で物々交換する付き合い、交流があるので、
 これを「ご近所付き合い」から範囲を広げたサービスにできないかと、考えました。
### サイト利用の流れ 
